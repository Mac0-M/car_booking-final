...
export class ComponentBadge {
  @Input() variant: 'available' | 'booked' | 'unavailable' | 'pending' = 'available';
  @Input() size: 'xs' | 'sm' | 'base' = 'sm';

    protected readonly baseClasses = 'inline-flex items-center justify-center font-medium rounded-xl transition-all duration-200 border-2 border-solid  ';
